                    ...
                    <tbody>
                        @foreach ($grop as $item)
                            <tr>
                                ...
                                <form action="{{ route('grop.edit', ['grop' => $item->id]) }}" method="get">
                                    @csrf
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form role="form" action="{{ route('grop.store') }}" method="POST"
                                    ...
                                    <div style="display: flex;justify-content: space-around;flex-wrap: wrap">
                                        <label for="exampleInputPassword1">نام زیر گروه</label>
                                        <input type="text" id="key" class="form-control"
                                            id="exampleInputPassword1">
                                        <input type="hidden" id="attrbute" value="" name="sub">
                                        <button class="addSub btn btn-info" style="margin-top: 12px;" type="submit"
                                            name="btn">اضافه زیر گروه</button>
                                    </div>
                                    <table class="table">
                                        <thead>
                                            <tr style="">
                                        ...
                                        <tbody class="subTbl" class="table">
